"""
    This file creates submission file based on predicted values from xgboost.
"""
...
predict_xgb = pd.read_csv("../model/xgb_predicted.txt", header=0, names=["prob"])
...
predict_df["predict_score"]  = np.log( predict_xgb["prob"].values / (1 - predict_xgb["prob"].values) )
